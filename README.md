...
2. To create a new flow draft click on the **Create Draft** button in the top right corner (
<img src="images/3_cdf_create_draft.png" alt="image" style="width:auto;height:30px;">
) and name it **\<userid>-syslog-kafka-flow**
